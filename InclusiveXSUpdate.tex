...
%
    ...
    Jiayi~Chen$^{16}$,
    Valerio~Dao$^{5}$,
    Silvia~Ferrario~Ravasio$^{17}$,
    Giancarlo~Ferrera$^{18}$,
    Alessandro~Gavardi$^{17}$,
    Yanping~Huang$^{19}$,
    Alexander~Huss$^{20}$,
    Stephen~Jones$^{21}$,
    Judith~Katzy$^{15}$,
    ...
    Alexander~M\"uck$^{25}$,
    Mathieu~Pellen$^{26}$,
    Christian~T.~Preuss$^{25}$,
    Michael~Spira$^{27}$,
    Lourdes~Urda~G\'omez$^{28}$,
    Marco~Vitti$^{11}$,
    Marius~Wiesemann$^{29}$,
    Malgorzata~Worek$^{25}$,
    Silvia~Zanoli$^{30}$,
...
% Format: institute, city, country
  ...
  {\bf 17} Universit\`{a} degli Studi di Torino \& INFN, Sezione di Torino, Via Giuria 1, 10125 Torino, Italy\\
  {\bf 18} Dipartimento di Fisica, Universit\`{a} di Milano \& INFN, Sezione di Milano, I-20133 Milan, Italy\\
  {\bf 19} Institute of High Energy Physics, Chinese Academy of Sciences, Beijing, China\\
  {\bf 20} Theoretical Physics Department, CERN, 1211 Geneva 23, Switzerland\\
  {\bf 21} Institute for Particle Physics Phenomenology, Durham University, South Road, Durham DH1 3LE, UK\\
  {\bf 22} Department of Physics and Astronomy, School of Mathematical and Physical Sciences, University of Sussex, Brighton, BN1 9RH, UK\\
  {\bf 23} Universit\`{a} degli Studi di Milano-Bicocca \& INFN Sezione di Milano-Bicocca, Piazza della Scienza 3, Milano 20126, Italy\\
  {\bf 24} Experimental Physics Department, CERN, 1211 Geneva 23, Switzerland\\
  {\bf 25} Institut f\"ur Theoretische Teilchenphysik und Kosmologie, RWTH Aachen University, 52056 Aachen, Germany\\
  {\bf 26} Physikalisches Institut, Albert-Ludwigs-Universit\"at Freiburg, D-79104 Freiburg, Germany\\
  {\bf 27} PSI Center for Neutron and Muon Sciences, CH-5232 Villigen PSI, Switzerland\\
  {\bf 28} The Institute of Modern Physics (IMP) of the Chinese Academy of Sciences, Fudan University, Shanghai (China)\\
  {\bf 29} Department of Physics, TU Dortmund University, 44227 Dortmund, Germany\\
  {\bf 30} Rudolf Peierls Centre for Theoretical Physics, Clarendon Laboratory, Parks Road, Oxford OX1 3PU, UK\\
  {\bf 31} Department of Physics, University of Maryland, College Park (UMD), 20742 College Park, USA
