...
%
    ...
    Christian~Br{\o}nnum-Hansen$^{10}$,
    Alessandro~Calandri$^{11}$,
    Alessandra~Cappati\textcolor{red}{$^{?}$},
    Andrea~Cardini$^{12}$,
    Suman~Chatterjee$^{13}$,
    Jiayi~Chen$^{14}$,
    Valerio~Dao$^{5}$,
    Silvia~Ferrario~Ravasio$^{15}$,
    Giancarlo~Ferrera$^{16}$,
    Alessandro~Gavardi$^{15}$,
    Yanping~Huang$^{17}$,
    Alexander~Huss$^{18}$,
    Stephen~Jones$^{19}$,
    Judith~Katzy$^{13}$,
    ...
    Alexander~M\"uck$^{22}$,
    Mathieu~Pellen$^{23}$,
    Christian~T.~Preuss$^{22}$,
    Michael~Spira$^{24}$,
    Lourdes~Urda~G\'omez$^{25}$,
    Marco~Vitti$^{10}$,
    Marius~Wiesemann$^{26}$,
    Malgorzata~Worek$^{22}$,
    Silvia~Zanoli$^{27}$,
...
% Format: institute, city, country
  ...
  {\bf 10} Institute for Theoretical Particle Physics, Karlsruhe Institute of Technology (KIT), Wolfgang-Gaede-Stra\ss{}e 1, 76131 Karlsruhe, Germany\\
  {\bf 11} Universit\`{a} degli Studi di Firenze \& INFN, Sezione di Firenze, Via Sansone 1, 50019 Sesto Fiorentino, Italy\\
  {\bf 12} Universidad de Oviedo, Instituto Universitario de Ciencias y Tecnolog\'{\i}as Espaciales de Asturias (ICTEA), Oviedo, Spain\\
  {\bf 13} Deutsches Elektronen-Synchrotron DESY, Notkestrasse 85, 22607 Hamburg, Germany\\
  {\bf 14} Department of Physics, 8888 University Dr W, Burnaby, BC V5A1S6, Canada\\
  {\bf 15} Universit\`{a} degli Studi di Torino \& INFN, Sezione di Torino, Via Giuria 1, 10125 Torino, Italy\\
  {\bf 16} Dipartimento di Fisica, Universit\`{a} di Milano \& INFN, Sezione di Milano, I-20133 Milan, Italy\\
  {\bf 17} Institute of High Energy Physics, Chinese Academy of Sciences, Beijing, China\\
  {\bf 18} Theoretical Physics Department, CERN, 1211 Geneva 23, Switzerland\\
  {\bf 19} Institute for Particle Physics Phenomenology, Durham University, South Road, Durham DH1 3LE, UK\\
  {\bf 20} Department of Physics and Astronomy, School of Mathematical and Physical Sciences, University of Sussex, Brighton, BN1 9RH, UK\\
  {\bf 21} Universit\`{a} degli Studi di Milano-Bicocca \& INFN Sezione di Milano-Bicocca, Piazza della Scienza 3, Milano 20126, Italy\\
  {\bf 22} Institut f\"ur Theoretische Teilchenphysik und Kosmologie, RWTH Aachen University, 52056 Aachen, Germany\\
  {\bf 23} Physikalisches Institut, Albert-Ludwigs-Universit\"at Freiburg, D-79104 Freiburg, Germany\\
  {\bf 24} PSI Center for Neutron and Muon Sciences, CH-5232 Villigen PSI, Switzerland\\
  {\bf 25} The Institute of Modern Physics (IMP) of the Chinese Academy of Sciences, Fudan University, Shanghai (China)\\
  {\bf 26} Department of Physics, TU Dortmund University, 44227 Dortmund, Germany\\
  {\bf 27} Rudolf Peierls Centre for Theoretical Physics, Clarendon Laboratory, Parks Road, Oxford OX1 3PU, UK\\
  {\bf 28} Department of Physics, University of Maryland, College Park (UMD), 20742 College Park, USA\\
