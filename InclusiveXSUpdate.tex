...
\pagestyle{SPstyle}
\begin{flushright}
LHCHWG-2026-005, FR-PHENO-2026-012, MPP-2026-150, OUTP-26-05P, TIF-UNIMI-2025-29, TTK-26-35
\end{flushright}
...
% Format: institute, city, country
  ...
  {\bf 18} PSI Center for Neutron and Muon Sciences, CH-5232 Villigen PSI, Switzerland\\
  {\bf 19} The Institute of Modern Physics (IMP) of the Chinese Academy of Sciences, Fudan University, Shanghai (China)\\
  {\bf 20} Rudolf Peierls Centre for Theoretical Physics, Clarendon Laboratory, Parks Road, Oxford OX1 3PU, UK\\
  {\bf 21} TIFLab, Universit\`{a} degli Studi di Milano \& INFN, Sezione di Milano, Via Celoria 16, 20133 Milano, Italy\\
  {\bf 22} Department of Physics, University of Maryland, College Park (UMD), 20742 College Park, USA\\
