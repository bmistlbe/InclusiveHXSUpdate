...
%
    ...
    Jiayi~Chen$^{11}$,
    Valerio~Dao$^{5}$,
    Silvia~Ferrario~Ravasio$^{12}$,
    Giancarlo~Ferrera$^{13}$,
...
% Format: institute, city, country
  ...
  {\bf 9} Universidad de Oviedo, Instituto Universitario de Ciencias y Tecnolog\'{\i}as Espaciales de Asturias (ICTEA), Oviedo, Spain\\
  {\bf 10} Deutsches Elektronen-Synchrotron DESY, Notkestrasse 85, 22607 Hamburg, Germany\\
  {\bf 11} Department of Physics, 8888 University Dr W, Burnaby, BC V5A1S6, Canada\\
  {\bf 12} Universit\`{a} degli Studi di Torino \& INFN, Sezione di Torino, Via Giuria 1, 10125 Torino, Italy\\
  {\bf 13} Dipartimento di Fisica, Universit\`{a} di Milano \& INFN, Sezione di Milano, I-20133 Milan, Italy\\
  {\bf 14} Theoretical Physics Department, CERN, 1211 Geneva 23, Switzerland\\
  {\bf 15} Institute for Particle Physics Phenomenology, Durham University, South Road, Durham DH1 3LE, UK\\
  {\bf 16} Department of Physics and Astronomy, School of Mathematical and Physical Sciences, University of Sussex, Brighton, BN1 9RH, UK\\
  {\bf 17} Universit\`{a} degli Studi di Milano-Bicocca \& INFN Sezione di Milano-Bicocca, Piazza della Scienza 3, Milano 20126, Italy\\
  {\bf 18} Institut f\"ur Theoretische Teilchenphysik und Kosmologie, RWTH Aachen University, 52056 Aachen, Germany\\
  {\bf 19} Physikalisches Institut, Albert-Ludwigs-Universit\"at Freiburg, D-79104 Freiburg, Germany\\
  {\bf 20} PSI Center for Neutron and Muon Sciences, CH-5232 Villigen PSI, Switzerland\\
  {\bf 21} The Institute of Modern Physics (IMP) of the Chinese Academy of Sciences, Fudan University, Shanghai (China)\\
  {\bf 22} Department of Physics, TU Dortmund University, 44227 Dortmund, Germany\\
  {\bf 23} Rudolf Peierls Centre for Theoretical Physics, Clarendon Laboratory, Parks Road, Oxford OX1 3PU, UK\\
  {\bf 24} TIFLab, Universit\`{a} degli Studi di Milano \& INFN, Sezione di Milano, Via Celoria 16, 20133 Milano, Italy\\
  {\bf 25} Department of Physics, University of Maryland, College Park (UMD), 20742 College Park, USA\\
