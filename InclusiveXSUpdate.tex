...
<<<<<<< HEAD
               ...
               {\bf $\boldsymbol{VH}$ conveners:} Suman Chatterjee$^{11}$, Valerio Dao$^{3}$, Giancarlo Ferrera$^{12}$, Matthew Lim$^{13}$, Marco Vitti$^{}$, Silvia Zanoli$^{}$\\
               ...
               Christian Br{\o}nnum-Hansen$^{18}$, Alexander M\"uck$^{19}$
           }} \\[0.3cm]	
           ...
           \textit{$^{18}$Institute for Theoretical Particle Physics, Karlsruhe Institute of Technology (KIT), Wolfgang-Gaede-Straße 1, 76131 Karlsruhe, Germany}\\
           \textit{$^{19}$Institute for Theoretical Particle Physics and Cosmology, RWTH Aachen University, 52056 Aachen, Germany}\\
  ...
  \begin{center}
    ...
    Specifically, Standard Model predictions for the LHC with centre-of-mass. energy of 7, 8, 13, 13.6 and 14 TeV are presented. \cite{xsecr5}
  \end{center}
  %
\end{titlepage}
\newpage
