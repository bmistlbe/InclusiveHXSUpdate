...
%
    ...
    Alexander~M\"uck$^{19}$,
    Mathieu~Pellen$^{20}$,
    Christian~T.~Preuss$^{19}$,
    Michael~Spira$^{21}$,
    Lourdes~Urda~G\'omez$^{22}$,
    Marco~Vitti$^{8}$,
    Marius~Wiesemann$^{23}$,
...
% Format: institute, city, country
  ...
  {\bf 15} Theoretical Physics Department, CERN, 1211 Geneva 23, Switzerland\\
  {\bf 16} Institute for Particle Physics Phenomenology, Durham University, South Road, Durham DH1 3LE, UK\\
  {\bf 17} Department of Physics and Astronomy, School of Mathematical and Physical Sciences, University of Sussex, Brighton, BN1 9RH, UK\\
  {\bf 18} Universit\`{a} degli Studi di Milano-Bicocca \& INFN Sezione di Milano-Bicocca, Piazza della Scienza 3, Milano 20126, Italy\\
  {\bf 19} Institut f\"ur Theoretische Teilchenphysik und Kosmologie, RWTH Aachen University, 52056 Aachen, Germany\\
  {\bf 20} Physikalisches Institut, Albert-Ludwigs-Universit\"at Freiburg, D-79104 Freiburg, Germany\\
  {\bf 21} PSI Center for Neutron and Muon Sciences, CH-5232 Villigen PSI, Switzerland\\
  {\bf 22} The Institute of Modern Physics (IMP) of the Chinese Academy of Sciences, Fudan University, Shanghai (China)\\
  {\bf 23} Department of Physics, TU Dortmund University, 44227 Dortmund, Germany\\
  {\bf 24} Rudolf Peierls Centre for Theoretical Physics, Clarendon Laboratory, Parks Road, Oxford OX1 3PU, UK\\
  {\bf 25} TIFLab, Universit\`{a} degli Studi di Milano \& INFN, Sezione di Milano, Via Celoria 16, 20133 Milano, Italy\\
  {\bf 26} Department of Physics, University of Maryland, College Park (UMD), 20742 College Park, USA\\
