...
$3\,000$--$4\,000\,\mathrm{fb}^{-1}$ per experiment, which will reduce
...
approximation~\cite{Barone:2025jey}. Associated production with a
$Z$ or a $W$ boson has reached NNLO QCD accuracy including the loop-induced
$gg\to ZH$ channel~\cite{Brein:2003wg,Ferrera:2011bk,Chen:2022rua},
while $t\bar{t}H$ production now benefits from NNLO QCD corrections
matched to NNLL soft-gluon resummation and combined with NLO
electroweak effects~\cite{Catani:2022mfv,Devoto:2024nhl}.  Production
in association with bottom quarks has reached N$^3$LO accuracy in the
...
have subsequently been combined~\cite{Cridge:2024icl}. The impact
of QED corrections to the DGLAP evolution has been assessed for the
first time in this
context~\cite{Manohar:2016nzj,Cooper-Sarkar:2025sqw} as well. These
developments affect not only the central predictions but, in several
cases, motivate a substantial revision of the associated theoretical
uncertainties, as we discuss in detail below.
