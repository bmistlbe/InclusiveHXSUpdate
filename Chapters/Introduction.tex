...
mode, is now known at N$^3$LO in QCD in the heavy-top-quark effective
...
effects~\cite{Das:2020adl}. Vector-boson fusion is now available at
N$^3$LO in QCD~\cite{Dreyer:2016oyx}, complemented by a detailed
assessment of non-factorisable corrections and of the quality of the
structure-function approximation~\cite{Barone:2025jey}.  Associated
production with a vector boson has reached NNLO QCD accuracy including
the loop-induced $gg\to ZH$
channel~\cite{Brein:2003wg,Ferrera:2011bk,Chen:2022rua}, while
$t\bar{t}H$ production now benefits from NNLO QCD corrections matched
...
have subsequently been combined~\cite{Cridge:2024icl}, and the impact
of QED corrections to the DGLAP evolution has been assessed for the
first time in this
context~\cite{Manohar:2016nzj,Cooper-Sarkar:2025sqw}.  These
