...
We note that the contributions $\sigma^{(b)}, \sigma^{(c)}$ and $\sigma^{(b \times c)}$ are small, accounting for $+0.21\%$, $0.002\%$ and $0.04\%$ of the total cross section, respectively.
...
The scale uncertainty is computed via a 7-point scale variation of $\mu_R =\mu_F$ about the central scale of $\MH/2$ with fixed $\alpha_s(M_Z)=0.118$.
...
In Ref.~\cite{Das:2020adl}, an approximation to this was calculated and at $\sqrt{s}=14$\,TeV it was found to give a $-0.1\%$ correction for the scale $\mu_R=\mu_F=\MH/2$ and to reduce the remaining scale uncertainty from about 5\% to less than 3\%.
