...
In Ref.~\cite{Das:2020adl}, an approximation to this was calculated and at $\sqrt{s}=14$\,TeV it was found to give a $-0.1\%$ correction for the scale $\mu_R=\mu_F=M_H/2$ and to reduce the remaining scale uncertainty from about 5\% to less than 3\%.
...
\caption{ Comparison of the recommendation and uncertainties of Yellow
  ...
  TeV and Higgs boson mass $m_H = 125$ GeV with all other parameters
