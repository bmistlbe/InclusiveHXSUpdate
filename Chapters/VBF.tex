...
In addition, regarding fixed-order calculations, the Les Houches wishlist~\cite{Huss:2025nlt} also provides a useful resource for recent developments.
...
The electroweak (EW) production of a Higgs boson in association with two jets (HJJ) features several contributions, the purely VBF one and the VH one.
