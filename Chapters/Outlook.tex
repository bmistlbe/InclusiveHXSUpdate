...
theory advancements made since the YR4. The update modifies both the central
...
predictions are consistent, within the R5 uncertainties, with the central
predictions of the YR4. Figure~\ref{fig:R5_uncertainties_breakdown} shows
...
VBF, ZH and ttH production modes, the anticipated precision of the
measurement at the HL-LHC exceeds or very nearly equals the YR4 theory
...
prediction. Overall, this comparison makes clear that the theoretical
...
Sec.~\ref{sec:an3lo-pdfs}. Establishing a robust common prescription for
