...
\end{align}
and effects due to the different choice of scales are neglected. The PDF and $\alpha_s$ uncertainties (denoted as $\Delta_\text{PDF}$ ad $\Delta_{\alpha_s}$, respectively) are calculated following the PDF4LHC recommendations.
