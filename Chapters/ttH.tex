...
\begin{equation}
    \Delta_{\rm virt} = 0.9\%\,
\end{equation}
for the numbers presented here. The total theory uncertainty, $\Delta_{\rm th}$, is computed by combining in quadrature this effect together with scale variations.
