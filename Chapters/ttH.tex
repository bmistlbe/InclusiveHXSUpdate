...
$t$-channel, $s$-channel and $tWH$ associated production. Their characteristics are very similar to single-top (without Higgs) production processes. As it is the case
...
five- and four-flavour scheme computation, both at NLO. For the 4FS prediction, we employ $m_b=4.92 \textrm{GeV}$.\\
...
Tabs.~\ref{tab:th-t-tot13},~\ref{tab:th-t-tot136},~\ref{tab:th-t-tot14};~\ref{tab:th-t-top13},~\ref{tab:th-t-top136},~\ref{tab:th-t-top14}; and~\ref{tab:th-t-atop13}~\ref{tab:th-t-atop136}~\ref{tab:th-t-atop14}
...
shows predictions for $tW^-H \,+ \,\bar t W^+H$ associated production (the cross section of the two separate processes are equal to each other in this case) at the three energies.
