...
\end{equation}
have been computed. Other values have been obtained via linear interpolation, using the formula
\begin{equation}
...
\begin{equation}
    m_H \in [ 124.6, 125., 125.09, 125.38, 125.6, 126.] \rm GeV\,,
\end{equation}
have been computed. Other values have been obtained via linear interpolation using Eq.~\ref{eq:inttth}.
